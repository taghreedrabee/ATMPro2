    ...
    internal class ATM
    {
            ...
            private void TransferMoney()
            {
                try
                {
                    ...
                    //if (_pendingTransfers == null)
                    //{
                    //    Console.WriteLine("Error: PendingTransferRepository is not initialized.");
                    //    return;
                    //}

                    //var recipientPendingTransfers = _pendingTransfers
                    //    .GetPendingTransfersByRecipientId(recipient.UserId)
                    //    .ToList();


                    //if (recipientPendingTransfers == null || !recipientPendingTransfers.Any())
                    //{
                    //    Console.WriteLine("No pending transfers found for the recipient.");
                    //}
                    //else
                    //{
